		...
		<div className="w-full  col-[full-start/full-end]  flex flex-col bg-theme-twilight-blue-500 overflow-hidden">
			<div className="flex flex-col items-center justify-center flex-1">
				<div className="flex flex-col items-center justify-center">
					<h1 className="text-3xl sm:text-6xl font-bold text-center text-theme-snow ">
						Christmas Game Dzajm
					</h1>
					<h2 className="text-base sm:text-2xl font-bold text-center text-theme-snow text-opacity-80">
